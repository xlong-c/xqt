...
def test_compile_wan21_vae_runner_delegates_to_compile_backend(
    ...
    monkeypatch.setattr("xqt.model.wan21_vae.compile_with_torch", fake_compile_with_torch)
...
def test_optimize_wan21_vae_compiles_and_warms_up(
    ...
    monkeypatch.setattr("xqt.model.wan21_vae.compile_wan21_vae_runner", fake_compile)
    monkeypatch.setattr("xqt.model.wan21_vae.warmup_wan21_vae_runner", fake_warmup)
...
def test_optimize_wan21_vae_captures_cuda_graph(
    ...
    monkeypatch.setattr("xqt.model.wan21_vae.capture_wan21_vae_cuda_graph", fake_capture)
