...
@pytest.mark.parametrize(
    ...
    [
        (
            "xqt/recipes/operator/torch_compile/operator_compile_cuda.yaml",
            "operator_torch_compile_cuda",
            "torch_compile",
            "model",
        ),
        (
            "xqt/recipes/operator/torch_compile/operator_vit_compile.yaml",
            "operator_torch_compile_vit",
            "torch_compile",
            "encoder_compile",
        ),
        (
            "xqt/recipes/operator/triton/operator_llm_mlp_triton.yaml",
            "operator_triton_llm_mlp",
            "triton",
            "mlp_triton",
        ),
        (
            "xqt/recipes/operator/tilelang/operator_attention_tilelang.yaml",
            "operator_tilelang_attention",
            "tilelang",
            "attention_tilelang",
        ),
        (
            "xqt/recipes/operator/cutile/operator_mlp_cutile.yaml",
            "operator_cutile_mlp",
            "cutile",
            "mlp_cutile",
        ),
        (
            "xqt/recipes/operator/cutlass/operator_mlp_cutlass.yaml",
            "operator_cutlass_mlp",
            "cutlass",
            "mlp_cutlass",
        ),
    ],
