...
def handle_tensorrt(
    ...
    *,
    ...
    plugin_validation = _ep.validate_tensorrt_plugin_libraries(
        tensorrt.plugin_libraries,
    ...
    tensorrt_metadata = {
        ...
        "loaded_plugin_libraries": result.metadata.get(
            ...
            plugin_validation.loaded_plugin_libraries,
        ),
        "serialize_plugin_libraries": result.metadata.get(
            "serialize_plugin_libraries"
        ),
        "plugin_validation": plugin_validation.to_dict(),
    ...
    tensorrt_runtime_layers = _ep.tensorrt_runtime_layer_report(
        target=target,
        build_result=result,
    ...
    tensorrt_metadata["tensorrt_runtime_layers"] = tensorrt_runtime_layers
    ...
    exported_entry: dict[str, object] = {
        ...
        "runtime_benchmark": runtime_benchmark,
        "plugin_validation": plugin_validation.to_dict(),
        "tensorrt_runtime_layers": tensorrt_runtime_layers,
        "performance_threshold_report": result.metadata.get(
            "performance_threshold_report"
        ),
    }
