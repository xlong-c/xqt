...
def handle_openvino(
    ...
    *,
    ...
    diff_data = diff.to_dict() if diff is not None else None
    openvino_runtime_layers = _ep.openvino_runtime_layer_report(
        target=target,
        export_result=result,
        output_diff=diff_data,
        source=source,
    )
    metadata = {
        ...
        "output_diff": diff_data,
        "openvino_runtime_layers": openvino_runtime_layers,
        **result.metadata,
    }
