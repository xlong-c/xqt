        ...
        *,
        ...
        if context.manifest is not None:
            ...
            for report in execution.reports:
                acceptance = operator_acceptance_record(report)
                context.manifest.add_metric(
                    MetricRecord(
                        ...
                        metadata={
                            ...
                            "min_speedup": acceptance["min_speedup"],
                            "effective_min_speedup": acceptance[
                                "effective_min_speedup"
                            ],
                            "meets_speedup": acceptance["meets_speedup"],
                            "meets_numeric": acceptance["meets_numeric"],
                            "graph_break_count": acceptance["graph_break_count"],
                            "graph_breaks": acceptance["graph_breaks"],
                            "graph_break_report": report.metadata.get(
                                "graph_break_report"
                            ),
                            "planned_skip_report": report.metadata.get(
                                "planned_skip_report"
                            ),
                            "quant_runtime_guard": report.metadata.get(
                                "quant_runtime_guard"
                            ),
                            "numeric_validation": report.metadata.get(
                                "numeric_validation"
                            ),
                            "mode": report.metadata.get("mode"),
                            "dynamic": report.metadata.get("dynamic"),
                            "fullgraph": report.metadata.get("fullgraph"),
                        },
                    )
                )
