"""Shared batch input helpers for XQT data, quantization, and evaluation paths."""
...
class BatchSplit:
    """Normalized model inputs and optional target tensor from a loader batch."""
...
def split_batch(
    ...
    *,
    ...
    """Best-effort split of a dataloader batch into model inputs and targets."""
...
def extract_model_inputs(
    ...
    *,
    ...
    """Return only the model input portion of a batch."""
