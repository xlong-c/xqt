...
from xqt.kernels.ops._impl.cutile import (
...
_mirror_registry(
    ...
    target="xqt.kernels.ops._impl.engines.cutile:run_cutile_kernel",
)
...
def build_cutile_artifact_metadata(
    ...
    artifact = artifact_metadata_path(resolved.cache_dir, pattern, "cutile")
    return {
        "engine": "cutile",
        "pattern": pattern,
