...
from xqt.kernels.ops.gemm.tuning_cache import resolve_builtin_gemm_schedule
...
from xqt.kernels.ops.quantization.nvfp4 import expand_group_scale, unpack_nvfp4e2m1
...
def gemm_reference(
    ...
    *,
    ...
    """Compatibility wrapper for the GEMM-owned dense reference path."""
