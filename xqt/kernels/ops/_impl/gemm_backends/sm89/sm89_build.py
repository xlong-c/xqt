...
from xqt.kernels.ops.gemm.preflight import (
...
_SEED_SOURCE = csrc_path("quantization", "int8mma_kernel.cu")
_DENSE_SOURCE = csrc_path("gemm", "dense_sm89.cu")
_W4A16_SOURCE = csrc_path("gemm", "w4a16_sm89.cu")
_W4A16_FUSED_SOURCE = csrc_path("gemm", "w4a16_cutlass_fused_sm89.cu")
_W4A16_GROUPED_SOURCE = csrc_path("gemm", "w4a16_grouped_sm89.cu")
_W8A8_GROUPED_SOURCE = csrc_path("gemm", "w8a8_grouped_sm89.cu")
_W8A16_SOURCE = _SEED_SOURCE
_W4A8_SOURCE = csrc_path("gemm", "w4a8_sm89.cu")
_FP8_PROBE_SOURCE = csrc_path("gemm", "fp8_cutlass_probe_sm89.cu")
_FP8_SOURCE = csrc_path("gemm", "fp8_cutlass_sm89.cu")
_FP8_GROUPED_SOURCE = csrc_path("gemm", "fp8_grouped_sm89.cu")
_MIXED_INPUT_PROBE_SOURCE = csrc_path("gemm", "mixed_input_probe_sm89.cu")
