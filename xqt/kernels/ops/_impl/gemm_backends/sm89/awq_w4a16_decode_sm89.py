...
from xqt.kernels.ops.gemm.contracts import GemmSpec, PackedWeight, PackedWeightMetadata
...
def sm89_awq_w4a16_decode_executor(
    ...
    *,
    ...
    if bias is not None:
        ...
        from xqt.kernels.ops._impl.cuda.awq_w4a16_sm89 import awq_w4a16_decode
