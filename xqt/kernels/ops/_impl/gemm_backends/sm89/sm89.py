...
from the historical kernel-wrapper location.  This adapter owns the logical
...
def _load_legacy_binding(artifact: Path) -> tuple[Any, Any]:
    ...
    from xqt.kernels.ops._impl.cute import int8mma_binding as binding
...
def prepack_sm89_int8_weight(
    ...
    *,
    ...
    from xqt.kernels.ops.gemm.contracts import PackedWeightMetadata
