...
Routing is table-driven: ``xqt.compression.quant.registry`` is the single source of truth
...
structured planned report (``xqt.compression.quant.backends.planned``) instead of an
...
from xqt.compression.quant import quantizers as _quantizers  # noqa: F401  # register routes
from xqt.compression.quant.backends.onnx_qdq import (
    onnx_qdq_graph_summary as _onnx_qdq_graph_summary,
    quantize_onnx_qdq_static,
)
from xqt.compression.quant.backends.planned import execute_planned_method_component
from xqt.compression.quant.backends.torchao import quantize_with_torchao
from xqt.compression.quant.capability import _resolve_nature
from xqt.compression.quant.component import prefix_module_names
from xqt.compression.quant.registry import RouteQuery, resolve_quant_route
from xqt.compression.quant.selection import selection_policy_metadata
