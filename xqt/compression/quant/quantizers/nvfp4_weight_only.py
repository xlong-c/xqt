...
from xqt.kernels.ops.quantization.nvfp4 import normalize_group_scale
from xqt.kernels.wrappers.nvfp4 import NVFP4LinearBridge
    ...
    def __init__(
        ...
        *,
        ...
        self.register_buffer(
            "weight_scale",
            normalize_group_scale(weight_scale).to(_NVFP4_SCALE_DTYPE),
        )
        self.register_buffer(
            "weight_global_scale",
