...
from xqt.compression.quant.execution.component import (
    ordered_unique,
    prefix_module_names,
...
from xqt.compression.quant.execution.selection import (
...
from xqt.compression.quant.strategy import normalize_quant_strategy
...
def quantize_moe_experts_weight_only(
    ...
    *,
    ...
    if method == "awq":
        ...
        from xqt.compression.quant.quantizers.awq_gptq_weight_only import quantize_with_gptq_weight_only
    ...
    from xqt.compression.quant.quantizers.moe_layout_report import build_expert_layout_reports
